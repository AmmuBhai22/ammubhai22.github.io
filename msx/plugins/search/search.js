...
var inputPage = {
    ...
    items: [
        ...
        createControlButton("clear", "home|end", 3, 3),
        ...
        if (data.data != null && TVXTools.isFullStr(data.data.action)) {
            ...
            if (action.indexOf("search:") == 0) {
                ...
                if (searchAction.indexOf("init:") == 0) {
                	...
                	if (searchAction.substr(8)=="done"){
                		url=TVXServices.urlParams.get("url");
                		param=TVXServices.urlParams.get("param");
                		seperator=TVXServices.urlParams.get("seperator");
                		if(param==null){
                			param="Query";
                		}
                		if (seperator==null){
                		...
                		if (url==null){
                			url="http://search.ammubhai99.serv00.net/msx";
                		}
                		fetch("http://search.ammubhai99.serv00.net/search",{
                			method:"POST",
                			body:"Search="+searchInput.replace(" ","+"),
                			headers: {
                				'Content-Type': 'application/x-www-form-urlencoded'
                			},
                		})
                		contentUrl=url+seperator+param+"=";
